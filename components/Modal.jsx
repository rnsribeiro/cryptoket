...
const Modal = ({ header, body, footer, handleClose}) => {
    ...
    return (
        <div className="flexCenter fixed inset-0 z-10 bg-overlay-black animated fadeIn" onClick={handleClickOutSide}>
            <div ref={modalRef} className="w-2/5 md:w-11/12 minlg:w-2/4 dark:bg-nft-dark 
            bg-white flex flex-col rounded-lg">
                ...
                <div className="flexCenter w-full text-center p-4">
                    ...
                    font-normal text-2xl">{header}</h2>
                </div>
                <div className="p-10 sm:px-4 border-t border-b dark:border-nft-black-3 
                border-nft-gray-1">
                    {body}
                </div>
