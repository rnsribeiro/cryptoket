...
const Navbar = () => {
    ...
    return (
        <nav className='flexBetween w-full fixed z-10 p-4 
                        flex-row border-b dark:bg-nft-dark bg-white 
            ...
            <div className='flex flex-initial flex-row justify-end'>
                <div className='flex items-center mr-2'>
                    ...
                    <label htmlFor="checkbox" className='flexBetween w-8 h-4 bg-black
            ...
            <div className='hidden md:flex ml-2'>
                {isOpen
                    ...
                    {isOpen && (
                        <div className='fixed inset-0 top-65 dark:bg-nft-dark bg-white z-10 nav-h
